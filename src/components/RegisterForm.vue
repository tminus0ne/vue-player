...
export default {
  ...
  data() {
    return {
      ...
      reg_alert_msg: 'Please wait! Yor account is being created.',
    };
  },
  methods: {
    async register(values) {
      ...
      this.reg_alert_msg = 'Please wait! Yor account is being created.';
      ...
      try {
        ...
        this.reg_alert_msg = `An error occured! ${error.message} Please try again later.`;
        return;
      }
